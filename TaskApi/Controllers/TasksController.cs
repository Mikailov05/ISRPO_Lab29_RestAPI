...
public class TasksController : ControllerBase
{
    ...
    public ActionResult<IEnumerable<TaskItem>> GetPriority(string level)
    {
    ...
    [HttpGet("sorted")]
    public ActionResult<IEnumerable<TaskItem>> GetSorted([FromQuery] string by = "id", [FromQuery] bool desc = false)
    {
